...
# ADD CPP /nologo /MD /W3 /GR /GX /Ot /Oi /Oy /Ob1 /I "..\.." /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /FD /c
# SUBTRACT CPP /Ox /YX
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\Release/Dlugosz Repertoire Ratwin.vc6{pb6+}.dll"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib /nologo /subsystem:windows /dll /incremental:no /debug /machine:I386 /out:"..\Debug/Dlugosz Repertoire Ratwin.vc6.debug{pb6+}.dll"
