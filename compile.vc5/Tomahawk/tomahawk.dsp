...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib /nologo /subsystem:windows /dll /machine:I386 /out:"..\Release/Dlugosz Repertoire Tomahawk.vc5{pb4}.dll"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comdlg32.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\Debug/Dlugosz Repertoire Tomahawk.vc5.debug{pb4}.dll"
